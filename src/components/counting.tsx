...
export function Counting() {
  ...
  return (
    <div className="space-y-10">
      <div>
        <p className="text-xs uppercase tracking-[0.2em] text-foreground-dim mb-3">Card Counting</p>
      ...
      {activeSection === 'learn' && (
        ...
        >
          <div className="bg-surface border border-rule rounded-2xl px-7 py-7 sm:px-9 sm:py-9 space-y-5">
            <p className="text-xs uppercase tracking-[0.2em] text-foreground-dim">The Hi-Lo System</p>
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4">
                ...
                <div className="text-foreground-dim text-[10px] uppercase tracking-[0.15em] mt-0.5">Low cards</div>
              </div>
              <div className="bg-foreground/5 border border-rule rounded-xl p-4">
                ...
                <div className="text-foreground-dim text-[10px] uppercase tracking-[0.15em] mt-0.5">Neutral</div>
              </div>
              <div className="bg-rose-500/10 border border-rose-500/20 rounded-xl p-4">
                ...
                <div className="text-foreground-dim text-[10px] uppercase tracking-[0.15em] mt-0.5">High cards</div>
              </div>
            </div>
          </div>

          <div className="bg-surface border border-rule rounded-2xl px-7 py-7 sm:px-9 sm:py-9 space-y-5">
            <p className="text-xs uppercase tracking-[0.2em] text-foreground-dim">Running Count &rarr; True Count</p>
            <p className="text-foreground-muted text-sm leading-relaxed">
          ...
          <div className="bg-surface border border-rule rounded-2xl px-7 py-7 sm:px-9 sm:py-9 space-y-5">
            <p className="text-xs uppercase tracking-[0.2em] text-foreground-dim">Betting Spread</p>
            <p className="text-foreground-muted text-sm leading-relaxed">
      ...
      {activeSection === 'practice' && (
        ...
        >
          ...
          <div className="flex flex-wrap gap-6 items-start">
            <div>
              <div className="text-foreground-dim text-[10px] uppercase tracking-[0.2em] mb-2">Decks</div>
            ...
            <div>
              <div className="text-foreground-dim text-[10px] uppercase tracking-[0.2em] mb-2">Speed</div>
              <div className="flex gap-1.5">
                {SPEEDS.map(s => (
                  <button
                    key={s.label}
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs text-foreground-dim tabular-nums">
            ...
            <AnimatePresence mode="wait">
              {currentCard ? (
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="text-foreground-dim text-xs uppercase tracking-[0.15em]">Ready</div>
                </div>
              )}
            </AnimatePresence>
          </div>
          ...
          <div className="flex gap-2 justify-center">
            <button
              ...
              className="h-11 px-7 rounded-full text-xs font-medium uppercase tracking-[0.12em] bg-accent/80 hover:bg-accent text-background transition-colors duration-200 disabled:opacity-30 disabled:cursor-not-allowed"
            >
              Next Card
            </button>
            <button
              ...
              className={`h-11 px-7 rounded-full text-xs font-medium uppercase tracking-[0.12em] transition-colors duration-200 disabled:opacity-30 disabled:cursor-not-allowed ${
                autoPlay
            ...
            <button
              onClick={newShoe}
              className="h-11 px-7 rounded-full text-xs font-medium uppercase tracking-[0.12em] border border-rule text-foreground-muted hover:text-foreground transition-colors duration-200"
            >
              New Shoe
            </button>
          </div>
          ...
          <div className="bg-surface border border-rule rounded-2xl px-7 py-6 sm:px-9 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-xs text-accent hover:text-accent/80 transition-colors uppercase tracking-[0.1em]"
              >
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={checkGuess}
                className="h-11 px-6 rounded-full text-xs font-medium uppercase tracking-[0.12em] bg-accent/80 hover:bg-accent text-background transition-colors duration-200"
              >
                Check
              </button>
            </div>
            ...
            {showCount && (
              <div className="grid grid-cols-2 gap-4 pt-3 border-t border-rule">
                <div>
                  <div className="text-foreground-dim text-[10px] uppercase tracking-[0.15em]">Running Count</div>
                  <div className="text-foreground text-xl font-semibold font-mono mt-1 tabular-nums">
                    {runningCount >= 0 ? '+' : ''}{runningCount}
                  </div>
                </div>
                <div>
                  <div className="text-foreground-dim text-[10px] uppercase tracking-[0.15em]">True Count</div>
                  <div className="text-foreground text-xl font-semibold font-mono mt-1 tabular-nums">
      ...
      {activeSection === 'deviations' && (
        ...
        >
          <div className="bg-surface border border-rule rounded-2xl px-7 py-7 sm:px-9 sm:py-9 space-y-4">
            <p className="text-xs uppercase tracking-[0.2em] text-foreground-dim">The Illustrious 18</p>
            <p className="text-foreground-muted text-sm leading-relaxed">
              ...
              <table className="w-full text-sm min-w-[400px]">
                <thead>
                  <tr className="border-b border-rule">
                    <th className="text-left py-3 px-7 sm:px-9 text-foreground-dim font-medium text-[10px] uppercase tracking-[0.15em]">Hand</th>
                    <th className="text-center py-3 text-foreground-dim font-medium text-[10px] uppercase tracking-[0.15em]">TC &ge;</th>
                    <th className="text-left py-3 text-foreground-dim font-medium text-[10px] uppercase tracking-[0.15em]">Deviation</th>
                    <th className="text-left py-3 pr-7 sm:pr-9 text-foreground-dim font-medium text-[10px] uppercase tracking-[0.15em]">Normal</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <div className="bg-surface border border-rule rounded-2xl px-7 py-7 sm:px-9 sm:py-9 space-y-4">
            <p className="text-xs uppercase tracking-[0.2em] text-foreground-dim">How to Use Deviations</p>
            <p className="text-foreground-muted text-sm leading-relaxed">
